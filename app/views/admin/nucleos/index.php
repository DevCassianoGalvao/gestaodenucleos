    ...
    <div class="table-wrap">
      <table class="responsive-table">
        ...
        <tbody>
          ...
          <tr>
            <td data-label="Núcleo" data-primary style="font-weight:600"><?= Security::esc($n['nome']) ?></td>
            <td data-label="Projeto" class="text-sm text-muted"><?= Security::esc($n['projeto']) ?></td>
            <td data-label="Município / UF" class="text-sm"><?= Security::esc($n['municipio']) ?>/<?= Security::esc($n['estado']) ?></td>
            <td data-label="Alunos"><?= $n['total_alunos'] ?></td>
            <td data-label="Professores"><?= $n['total_professores'] ?></td>
            <td data-label="Status"><span class="badge <?= $n['status'] === 'ativo' ? 'badge-verde' : 'badge-cinza' ?>"><?= $n['status'] === 'ativo' ? 'Ativo' : 'Inativo' ?></span></td>
