...
<div class="public-header">
  <div class="public-header-logo">
    <i data-lucide="user-plus" style="width:28px;height:28px;color:#fff;stroke-width:1.5"></i>
  </div>
...
<div class="public-body">
  ...
  <div style="margin-bottom:1.25rem;padding:.875rem 1rem;background:#EFF6FF;border:1px solid #BFDBFE;border-radius:var(--radius-sm)">
    <div style="font-size:.8rem;color:#1E40AF;font-weight:600;margin-bottom:.25rem">Inscrição para o núcleo:</div>
  ...
  <form method="POST"
        action="<?= Security::esc(APP_URL) ?>/convite/aluno/<?= Security::esc($token ?? '') ?>"
...
<div class="public-footer">
  ...
  Uso múltiplo — compartilhe com outros alunos.
</div>
